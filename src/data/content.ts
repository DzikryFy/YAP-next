...
export const EDUCATIONAL_UNITS: UnitItem[] = [
  {
    ...
    iconBg: '#d99a1e',
    badgeBorder: '#d99a1e',
    buttonBorder: 'border-[#b77e12] text-[#8f610d] hover:bg-amber-50',
    buttonText: 'text-[#8f610d]',
  ...
  },
  {
    ...
    iconBg: '#075b3a',
    badgeBorder: '#075b3a',
    buttonBorder: 'border-[#075b3a] text-[#075b3a] hover:bg-teal-50',
    buttonText: 'text-[#075b3a]',
