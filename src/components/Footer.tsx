...
export const Footer: React.FC<FooterProps> = ({ onNavigate, onSelectUnit }) => {
  ...
  return (
    <footer id="footer-section" className="relative bg-[#0C4229] text-white pt-14 pb-10 px-4 sm:px-8 border-t border-[#0C4229] overflow-hidden">
      {/* Top subtle line */}
          ...
          <div className="lg:col-span-4 space-y-5">
            ...
            <div className="flex items-center gap-3 pt-1">
              <a
                ...
                className="w-9 h-9 rounded-full bg-[#0C4229] hover:bg-[#082F1D] border border-white/20 flex items-center justify-center text-white/90 hover:text-white transition-all shadow-xs"
              >
