...
export const SectionDivider: React.FC<SectionDividerProps> = ({ className = '' }) => {
  return (
    ...
    >
      ...
      >
        <svg className="w-full h-full text-[#d99a1e]/20" preserveAspectRatio="none">
          <pattern id="islamic-band-pattern" x="0" y="0" width="80" height="40" patternUnits="userSpaceOnUse">
            ...
            <path 
              ...
              opacity="0.35" 
            />
            <line x1="0" y1="20" x2="80" y2="20" stroke="#075B3A" strokeWidth="0.5" strokeDasharray="3 3" opacity="0.2" />
          </pattern>
      ...
      <div className="relative z-10 w-full max-w-7xl px-4 sm:px-8 flex items-center justify-center">
        ...
        <div className="flex-1 flex items-center justify-end">
          <div className="w-full max-w-md h-[1.5px] bg-gradient-to-r from-transparent via-[#0C4229]/50 to-[#d99a1e]" />
          {/* Small Hollow Diamond on the Left */}
          <div className="w-2.5 h-2.5 border border-[#d99a1e] rotate-45 ml-2 mr-2.5 bg-[#f4f8f5] shrink-0" />
          {/* Small Gold Dot Left */}
          <div className="w-1.5 h-1.5 rounded-full bg-[#d99a1e] shrink-0 mr-3" />
        </div>
        ...
        <div className="relative flex items-center justify-center w-8 h-8 shrink-0 mx-1">
          ...
          <div className="absolute inset-1 border-[1.5px] border-[#d99a1e] rotate-45 rounded-[2px]" />
        ...
        <div className="flex-1 flex items-center justify-start">
          ...
          <div className="w-1.5 h-1.5 rounded-full bg-[#d99a1e] shrink-0 ml-3" />
          {/* Small Hollow Diamond on the Right */}
          <div className="w-2.5 h-2.5 border border-[#d99a1e] rotate-45 ml-2.5 mr-2 bg-[#f4f8f5] shrink-0" />
          <div className="w-full max-w-md h-[1.5px] bg-gradient-to-r from-[#d99a1e] via-[#0C4229]/50 to-transparent" />
        </div>

      </div>

      {/* Subtle bottom accent line */}
      <div className="absolute bottom-1 left-0 w-full h-[0.5px] bg-gradient-to-r from-transparent via-[#d99a1e]/20 to-transparent pointer-events-none" />
    </div>
  );
};
